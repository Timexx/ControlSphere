const messages = {
  ...
  machine: {
    ...
    systemUpdateDialog: {
      ...
      updateAllLabel: 'Update all {count} packages',
      refreshList: 'Refresh list',
      searchPlaceholder: 'Search packages...',
      packageCount: '{total} updates available',
      packageCountFiltered: '{filtered} of {total} updates',
      loading: 'Loading packages...',
      noUpdates: 'No updates available',
      noResults: 'No packages found',
      updateBtn: 'Update',
      infoText: 'This list reflects the last security scan. New updates will only appear after a new scan.',
      lastScan: 'Last scan:',
      scanNowBtn: 'Scan now',
      scanNowTitle: 'Start new security scan',
      terminalTitle: 'Live Terminal',
      terminalConnected: 'Connected',
      terminalConnecting: 'Connecting...',
      terminalConnectingMsg: 'Connecting to remote terminal...',
      terminalActiveAll: 'All packages',
      terminalPlaceholderTitle: 'Terminal ready',
      terminalPlaceholderHint: 'Click \u201cUpdate\u201d on a package to start the terminal',
      terminalUpdateAllBtn: 'Update all {count} packages',
      terminalInteractive: 'The terminal is interactive \u2013 you can intervene at any time.',
      toastTitle: 'Security scan started',
      toastDesc: 'The agent is now running a new scan. The package list will be refreshed once it completes.',
    },
    metrics: {
      title: 'Live metrics',
      cpu: 'CPU usage',
  ...
  settings: {
    ...
    logs: {
      ...
      selectFile: 'Select a log file to view its contents.',
      filter: 'Filter lines…',
    ...
    update: {
      eyebrow: 'System',
      title: 'Server Update',
      description: 'Check for and apply ControlSphere updates from the official repository.',
      version: 'Version',
      buildSha: 'Build',
      githubCommit: 'GitHub',
      ...
      latestLabel: 'Latest',
      commitsAhead: '{count, plural, one {# new commit} other {# new commits}} available',
      newVersion: 'A newer version is available.',
      changelog: 'Changelog',
      andMore: 'and {count} more...',
      startUpdate: 'Update server',
      dismiss: 'Dismiss',
      migrationNote: 'Database migrations are applied automatically during the update.',
      logLabel: 'Update log',
      retry: 'Retry',
      auth: {
        title: 'Confirm server update',
        description: 'The server will restart during the update. All agents reconnect automatically.',
      ...
      progress: {
        title: 'Updating ControlSphere',
        pulling: 'Pulling latest code...',
        building: 'Building application...',
        restarting: 'Restarting server...',
        waitingRestart: 'Waiting for server to come back online...',
  ...
  notifications: {
    ...
    subtitle: 'Configure email alerts for important system events. Requires an SMTP-capable email account.',
    adminOnly: 'Notifications are an admin-only feature.',

    provider: {
      eyebrow: 'Email Provider',
      title: 'SMTP Configuration',
      description: 'Connect any SMTP-capable email account. For Gmail, use an App Password (Google Account → Security → App Passwords).',
      host: 'SMTP Host',
      ...
      fromEmailPlaceholder: 'controlsphere@yourdomain.com',
      fromName: 'From Name',
      fromNamePlaceholder: 'ControlSphere',
      tls: 'Use TLS / STARTTLS',
      verifyCert: 'Verify TLS Certificate',
      recipients: 'Recipient Addresses',
      recipientsPlaceholder: 'admin@example.com, ops@example.com',
      recipientsHint: 'Separate multiple addresses with commas.',
    ...
    schedule: {
      ...
      description: 'Choose when to receive notifications. "Immediate" sends as soon as an event occurs. "Daily Digest" batches all events into a single daily summary.',
      modeLabel: 'Default delivery mode',
      modeImmediate: 'Immediate',
      modeDigest: 'Daily Digest',
      digestEnabled: 'Enable daily digest',
      digestTime: 'Send digest at',
    ...
    events: {
      ...
      description: 'Select which events trigger a notification and how they are delivered.',
      categories: {
      ...
      items: {
        criticalCve:            'Critical CVE Found',
        highCve:                'High CVE Found',
        securityEvent:          'Security Event Detected',
        integrityViolation:     'Integrity Violation',
        eventsResolved:         'Security Events Resolved',
        ...
        machineUpdatesAvailable:'Machine Updates Available',
        userCreated:            'New User Created',
        userRoleChanged:        'User Role Changed',
        loginBlocked:           'Login Attempt Blocked',
        bulkJobCompleted:       'Bulk Job Completed',
      },
      descriptions: {
        criticalCve:            'A critical severity CVE was matched against installed packages',
        highCve:                'A high severity CVE was matched against installed packages',
        securityEvent:          'Failed authentication or suspicious activity detected',
        integrityViolation:     'File integrity or configuration drift detected on a machine',
        eventsResolved:         'One or more security events were marked as resolved',
        agentRegistered:        'A new machine connected and registered for the first time',
        agentOffline:           'A monitored machine lost connection to the server',
        machineDeleted:         'A machine was permanently removed from ControlSphere',
        scanCompleted:          'A full security scan finished with a summary of findings',
        serverUpdateAvailable:  'A new version of ControlSphere server is available on GitHub',
        machineUpdatesAvailable:'One or more managed machines have pending OS/package updates',
        userCreated:            'A new user account was created in ControlSphere',
        userRoleChanged:        "A user's role or permissions were modified",
        loginBlocked:           'A login was blocked due to deactivated account or rate limiting',
        bulkJobCompleted:       'A bulk management job finished execution across target machines',
      },
    },
    ...
    history: {
      ...
      description: 'Last 50 notification attempts.',
    ...
    errors: {
      ...
      smtpRequired:     'SMTP host and from address are required.',
      recipientRequired:'At least one recipient address is required.',
