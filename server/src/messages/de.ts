const messages = {
  ...
  notifications: {
    eyebrow: 'Meldungen & Benachrichtigungen',
    title: 'Benachrichtigungs-Einstellungen',
    subtitle: 'Konfiguriere E-Mail-Benachrichtigungen für wichtige Systemereignisse. Erfordert einen SMTP-fähigen E-Mail-Account.',
    adminOnly: 'Benachrichtigungen sind nur für Administratoren verfügbar.',

    provider: {
      eyebrow: 'E-Mail-Anbieter',
      title: 'SMTP-Konfiguration',
      description: 'Verbinde einen beliebigen SMTP-fähigen E-Mail-Account. Für Gmail ein App-Passwort verwenden (Google-Konto → Sicherheit → App-Passwörter).',
      host: 'SMTP-Host',
      hostPlaceholder: 'smtp.gmail.com',
      port: 'Port',
      username: 'Benutzername / E-Mail',
      usernamePlaceholder: 'dich@gmail.com',
      password: 'Passwort / App-Passwort',
      passwordPlaceholder: '••••••••••••••••',
      passwordHint: 'Leer lassen, um das bestehende Passwort beizubehalten.',
      fromEmail: 'Absender-Adresse',
      fromEmailPlaceholder: 'controlsphere@deinedomain.de',
      fromName: 'Absender-Name',
      fromNamePlaceholder: 'ControlSphere',
      tls: 'TLS / STARTTLS verwenden',
      verifyCert: 'TLS-Zertifikat prüfen',
      recipients: 'Empfänger-Adressen',
      recipientsPlaceholder: 'admin@beispiel.de, ops@beispiel.de',
      recipientsHint: 'Mehrere Adressen mit Komma trennen.',
    ...
    schedule: {
      eyebrow: 'Zustellung',
      title: 'Benachrichtigungs-Zeitplan',
      description: 'Lege fest, wann du Benachrichtigungen erhältst. "Sofort" sendet direkt beim Ereignis. "Tages-Digest" fasst alle Ereignisse in einer täglichen Zusammenfassung zusammen.',
      modeLabel: 'Standard-Zustellmodus',
      modeImmediate: 'Sofort',
      modeDigest: 'Tages-Digest',
      digestEnabled: 'Tages-Digest aktivieren',
      digestTime: 'Digest senden um',
      serverTime: '(Server-Lokalzeit)',
      digestDays: 'An diesen Tagen',
      days: {
        sun: 'So',
        mon: 'Mo',
        tue: 'Di',
    ...
    events: {
      eyebrow: 'Ereignisse',
      title: 'Ereignis-Abonnements',
      description: 'Wähle, bei welchen Ereignissen du benachrichtigt werden möchtest und wie die Zustellung erfolgt.',
      categories: {
      ...
      items: {
        criticalCve:            'Kritische CVE gefunden',
        highCve:                'Hohe CVE gefunden',
        securityEvent:          'Sicherheitsereignis erkannt',
        integrityViolation:     'Integritätsverletzung',
        eventsResolved:         'Sicherheitsereignisse aufgelöst',
        agentRegistered:        'Neuer Agent registriert',
        agentOffline:           'Agent offline gegangen',
        machineDeleted:         'Maschine gelöscht',
        scanCompleted:          'Sicherheits-Scan abgeschlossen',
        serverUpdateAvailable:  'Server-Update verfügbar',
        machineUpdatesAvailable:'Maschinen-Updates verfügbar',
        userCreated:            'Neuer Benutzer angelegt',
        userRoleChanged:        'Benutzerrolle geändert',
        loginBlocked:           'Anmeldeversuch blockiert',
        bulkJobCompleted:       'Bulk-Job abgeschlossen',
      },
      descriptions: {
        criticalCve:            'Eine kritische CVE wurde in installierten Paketen gefunden',
        highCve:                'Eine hohe CVE wurde in installierten Paketen gefunden',
        securityEvent:          'Fehlgeschlagene Anmeldung oder verdächtige Aktivität erkannt',
        integrityViolation:     'Datei-Integrität oder Konfigurationsabweichung auf einer Maschine erkannt',
        eventsResolved:         'Ein oder mehrere Sicherheitsereignisse wurden als aufgelöst markiert',
        agentRegistered:        'Eine neue Maschine hat sich zum ersten Mal verbunden und registriert',
        agentOffline:           'Eine überwachte Maschine hat die Verbindung zum Server verloren',
        machineDeleted:         'Eine Maschine wurde dauerhaft aus ControlSphere entfernt',
        scanCompleted:          'Ein vollständiger Sicherheits-Scan wurde mit einer Zusammenfassung abgeschlossen',
        serverUpdateAvailable:  'Eine neue Version des ControlSphere-Servers ist auf GitHub verfügbar',
        machineUpdatesAvailable:'Eine oder mehrere Maschinen haben ausstehende Paket-Updates',
        userCreated:            'Ein neues Benutzerkonto wurde in ControlSphere erstellt',
        userRoleChanged:        'Die Rolle oder Berechtigungen eines Benutzers wurden geändert',
        loginBlocked:           'Eine Anmeldung wurde wegen deaktiviertem Konto oder Rate-Limiting blockiert',
        bulkJobCompleted:       'Ein Bulk-Job wurde auf den Zielmaschinen ausgeführt',
      },
    },
    ...
    history: {
      ...
      description: 'Letzte 50 Benachrichtigungsversuche.',
    ...
    errors: {
      ...
      smtpRequired:     'SMTP-Host und Absender-Adresse sind erforderlich.',
      recipientRequired:'Mindestens eine Empfänger-Adresse ist erforderlich.',
